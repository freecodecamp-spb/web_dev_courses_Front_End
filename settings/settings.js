var Settings = {
    ...
    MOTD: "\nЧитайте вики проекта на гитхабе! Часть HTML переведена в кастомные директивы!", // Указывайте здесь сообщения дня, если есть что передать другим разработчикам.
